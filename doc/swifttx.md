...
This mechanism has been integrated into Bitcore-Node-TWINS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TWINS-Project/insight-api-twins#web-socket-api](https://github.com/TWINS-Project/insight-api-twins#web-socket-api) 
* API: [https://github.com/TWINS-Project/insight-api-twins#swifttx-transactions](https://github.com/TWINS-Project/insight-api-twins#swifttx-transactions) 
...
By default, the TWINS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TWINS Core daemon:
