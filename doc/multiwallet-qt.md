...
In order to support loading of multiple wallets in twins-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is twins.cpp.
...
Changes to twins.cpp
----------------------
twins.cpp is the entry point into twins-qt, and as such, will require some minor modifications to provide hooks for
