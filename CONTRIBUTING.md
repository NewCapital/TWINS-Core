Contributing to TWINS Core
============================

The TWINS Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TWINS Core project, and is not to be
confused with overall TWINS Network Protocol consensus changes.

Whether a pull request is merged into TWINS Core rests with the project merge
...
Patches that change TWINS consensus rules are considerably more involved than
...
Where a patch set proposes to change the TWINS consensus, it must have been
...
The project leader is the release manager for each TWINS Core release.
