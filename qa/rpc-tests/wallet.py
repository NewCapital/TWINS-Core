...
#   c) node1 mines 32 blocks, so now node 0 has 60001twins, node 1 has 4250twins, node2 has none.
#   d) node0 sends 601 twins to node2, in two transactions (301 twins, then 300 twins).
