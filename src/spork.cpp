...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_TWINS_01_CHECKPOINT_HEIGHT) r = SPORK_TWINS_01_CHECKPOINT_HEIGHT_DEFAULT;
        if (nSporkID == SPORK_TWINS_02_CHECKPOINT_HASHBITS_0_63) r = SPORK_TWINS_02_CHECKPOINT_HASHBITS_0_63_DEFAULT;
        if (nSporkID == SPORK_TWINS_03_CHECKPOINT_HASHBITS_64_127) r = SPORK_TWINS_03_CHECKPOINT_HASHBITS_64_127_DEFAULT;
        if (nSporkID == SPORK_TWINS_04_CHECKPOINT_HASHBITS_128_191) r = SPORK_TWINS_04_CHECKPOINT_HASHBITS_128_191_DEFAULT;
        if (nSporkID == SPORK_TWINS_05_CHECKPOINT_HASHBITS_192_255) r = SPORK_TWINS_05_CHECKPOINT_HASHBITS_192_255_DEFAULT;
...
bool CSporkManager::CheckSignature(CSporkMessage& spork, bool fCheckSigner)
{
    ...
    if (!fValidWithNewKey && spork.nValue > 1000000 && spork.nValue < Params().RejectOldSporkKey() &&
		chainActive.Tip()->GetBlockTime() < Params().RejectOldSporkKey()) {
        LogPrintf("Checking Spork signed with OLD KEY: Spork.nValue %d RejectTime %d AdjustedTime %d ChainActiveBlockTime %d\n",
		spork.nValue, Params().RejectOldSporkKey(), GetAdjustedTime(), chainActive.Tip()->GetBlockTime());
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_TWINS_01_CHECKPOINT_HEIGHT") return SPORK_TWINS_01_CHECKPOINT_HEIGHT;
    if (strName == "SPORK_TWINS_02_CHECKPOINT_HASHBITS_0_63") return SPORK_TWINS_02_CHECKPOINT_HASHBITS_0_63;
    if (strName == "SPORK_TWINS_03_CHECKPOINT_HASHBITS_64_127") return SPORK_TWINS_03_CHECKPOINT_HASHBITS_64_127;
    if (strName == "SPORK_TWINS_04_CHECKPOINT_HASHBITS_128_191") return SPORK_TWINS_04_CHECKPOINT_HASHBITS_128_191;
    if (strName == "SPORK_TWINS_05_CHECKPOINT_HASHBITS_192_255") return SPORK_TWINS_05_CHECKPOINT_HASHBITS_192_255;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_TWINS_01_CHECKPOINT_HEIGHT) return "SPORK_TWINS_01_CHECKPOINT_HEIGHT";
    if (id == SPORK_TWINS_02_CHECKPOINT_HASHBITS_0_63) return "SPORK_TWINS_02_CHECKPOINT_HASHBITS_0_63";
    if (id == SPORK_TWINS_03_CHECKPOINT_HASHBITS_64_127) return "SPORK_TWINS_03_CHECKPOINT_HASHBITS_64_127";
    if (id == SPORK_TWINS_04_CHECKPOINT_HASHBITS_128_191) return "SPORK_TWINS_04_CHECKPOINT_HASHBITS_128_191";
    if (id == SPORK_TWINS_05_CHECKPOINT_HASHBITS_192_255) return "SPORK_TWINS_05_CHECKPOINT_HASHBITS_192_255";
