...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_TWINS_02_MIN_STAKE_AMOUNT") return SPORK_TWINS_02_MIN_STAKE_AMOUNT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_TWINS_02_MIN_STAKE_AMOUNT) return "SPORK_TWINS_02_MIN_STAKE_AMOUNT";
