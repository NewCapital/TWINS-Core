                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    labelAutoMintIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); border: 0px solid #465156;}");
    ...
    labelEncryptionIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); border: 0px solid #465156;}");
    ...
    labelConnectionsIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); border: 0px solid #465156;}");
...
/*    privacyAction = new QAction(QIcon(":/icons/privacy"), tr("&Privacy"), this);
    privacyAction->setStatusTip(tr("Privacy Actions for zTWINS"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TWINS Core"), this);
    aboutAction->setStatusTip(tr("Show information about TWINS Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for TWINS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TWINS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TWINS addresses"));
    ...
    openAction->setStatusTip(tr("Open a TWINS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TWINS Core help message to get a list with possible TWINS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TWINS Core client") + " " + networkStyle->getTitleAddText();
...
{
    QDesktopServices::openUrl(QUrl("https://tvaru.shop/winwin", QUrl::TolerantMode));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TWINS network", "", count));
}
...
{
    QString strTitle = tr("TWINS Core"); // default title
