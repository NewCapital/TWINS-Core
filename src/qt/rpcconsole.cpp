                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTWINSPathCustom = GetArg("-ztwinsbackuppath", "");
    ...
    if(!strzTWINSPathCustom.empty()) {
        ui->wallet_customztwinsbackuppath->setText(QString::fromStdString(strzTWINSPathCustom));
        ui->wallet_customztwinsbackuppath_label->setVisible(true);
        ui->wallet_customztwinsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTWINSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TWINS RPC console.") + "<br>" +
