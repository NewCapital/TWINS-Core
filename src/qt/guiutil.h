...
/** Utility functions used by the TWINS Qt UI.
 */
namespace GUIUtil
{
...
// Render TWINS addresses in monospace font
...
// Parse "twins:" URI into recipient object, return true on successful parsing
