...
This means one can have an always-on twinsd instance running, and another local twinsd/twins-qt instance which connects to this node and receives blocks from it.
